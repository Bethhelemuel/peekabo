package com.peekaboo.spacehead.peekaboo.Utils.ItemUtilities.Movie;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ExampleViewHolder> implements View.OnClickListener {
    ...
    public MovieAdapter(Context context, ArrayList<VideoVO> exampleList) {
        mContext = context;
    ...
    public void onBindViewHolder(ExampleViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent= new Intent(mContext, MoviePreviewActivity.class);
